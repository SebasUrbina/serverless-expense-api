...
export function PWAController() {
  ...
  return (
    <>
      {!isOnline ? (
        <div
          className="fixed inset-x-3 top-3 z-[120] flex items-center gap-3 rounded-2xl px-4 py-3 text-sm shadow-lg animate-seva-slide-up sm:left-auto sm:right-4 sm:top-4 sm:w-[360px]"
          style={{
      ...
      {canInstall ? (
        <div className="fixed inset-x-3 bottom-[6.2rem] z-[115] animate-seva-slide-up sm:bottom-4 sm:left-auto sm:right-4 sm:w-[360px]">
          <div
            className="rounded-[1.6rem] p-4 shadow-[0_18px_45px_rgba(0,0,0,0.28)]"
            style={{
              background:
                "linear-gradient(135deg, rgba(16,185,129,0.15), rgba(12,16,21,0.95))",
          ...
          >
            <div className="mb-3 flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.24em] text-emerald-300/75">
                  Instalar app
                </p>
              ...
              <button
                ...
                className="inline-flex h-8 w-8 items-center justify-center rounded-xl text-emerald-100/70 transition-colors hover:bg-[var(--text-primary)]/8 hover:text-primary"
            ...
            <p className="text-sm leading-5 text-emerald-50/72">
              Vas a entrar más rápido, con experiencia tipo app y acceso sin
              conexión a las pantallas que ya viste.
            </p>
            <button
              type="button"
              onClick={() => void handleInstall()}
              className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-2xl px-4 py-3 text-sm font-semibold text-primary transition-colors"
