...
export function DeleteButton({
  ...
  const baseClasses =
    'w-full py-4 rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 text-red-500 hover:text-red-600 bg-red-500/10 hover:bg-red-500/20';
  ...
  const unifiedClasses =
    'sm:bg-transparent sm:hover:bg-red-500/10 font-bold sm:font-semibold';
