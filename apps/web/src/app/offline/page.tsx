...
export default function OfflinePage() {
  return (
    <main
      ...
      style={{
        background:
          'radial-gradient(circle at top, rgba(16,185,129,0.14), transparent 28%), var(--bg-base)',
      }}
    >
      <div className="mx-auto flex min-h-[80vh] max-w-xl flex-col items-center justify-center text-center">
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(16,185,129,0.18), rgba(6,8,12,0.04))',
        ...
        <p
          className="mb-2 text-[11px] font-bold tracking-[0.28em] uppercase"
        ...
        <p
          className="mb-8 max-w-md text-sm leading-6 sm:text-base"
          style={{ color: 'var(--text-secondary)' }}
        >
          Puedes volver al dashboard cuando recuperes conexión. La app mantendrá
          disponibles las pantallas que ya quedaron cacheadas.
        </p>
